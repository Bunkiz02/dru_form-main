					...
					<table class="table table-bordered table-hover table-sortable" id="tab_logic">
						...
						<tbody>
							...
							<tr id='addr0' data-id="0" class="hidden">
								<td data-name="number">
									<input type="intiger" name='num0' placeholder='กรุณากรอกข้อมูล'
										class="form-control" />
								</td>

								<td data-name="list">
									<input type="text" name='list0' placeholder='กรุณากรอกข้อมูล'
										class="form-control" />
								</td>
								<td data-name="count1">
									<input type="text" name='count0' placeholder='กรุณากรอกข้อมูล'
										class="form-control" />
								</td>
								<td data-name="count2">
									<input type="text" name='count2_0' placeholder='กรุณากรอกข้อมูล'
										class="form-control" />
								</td>
								<td data-name="Des">
									<textarea name="desc0" placeholder="กรุณากรอกข้อมูล"
